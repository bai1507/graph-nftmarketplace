...
export class ItemWithdraw extends ethereum.Event {
  get params(): ItemWithdraw__Params {
    return new ItemWithdraw__Params(this);
  }
}

export class ItemWithdraw__Params {
  _event: ItemWithdraw;

  constructor(event: ItemWithdraw) {
    this._event = event;
  }
